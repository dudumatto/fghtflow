...
2. Contexto do projeto (este repo: `backend/`, `frontend/`, `docs/`, `README.md`, etc.) = apenas o necessário para a tarefa atual.
...
- `docs/security.md` (seguranca)
- `docs/api.md` (contrato API)
- `docs/testing.md` (testes)
- `ai/TEST_REPORT.md` (auditoria e pendencias)
...
- `ai/PROJECT_CONTEXT.md` (crie/atualize apenas quando houver decisoes de arquitetura do projeto)
- `ai/MEMORY.md` (curto: bugs + solucoes + comandos de validacao; evitar historico longo)
