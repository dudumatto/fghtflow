...
import { UI_BASE, athleteProfile, createAula, createPlano, registerAthlete, registerUser, seedAuth } from "../support/e2e-api";
...
test("professor registra presenca e bloqueia duplicada", async ({ page }) => {
  ...
  await page.goto(`${UI_BASE}/agenda/${aula.id}/presencas`);
